...
class TestWorkerManagerAutomaticRaw:
    ...
    def test_start_file_scan_calls_scanner_without_apply_auto_edits(self, mock_file_scanner_class, mock_qthread):
    ...
    @patch('src.ui.worker_manager.QThread')
    @patch('src.ui.worker_manager.FileScanner')
    def test_file_scan_workflow_integration(self, mock_file_scanner_class, mock_qthread):
    ...
    @patch('src.ui.worker_manager.QThread')
    @patch('src.ui.worker_manager.FileScanner')  
    def test_multiple_scan_requests_stop_previous(self, mock_file_scanner_class, mock_qthread):
...
class TestWorkerManagerBackwardCompatibility:
    ...
    def test_method_still_accepts_expected_parameters(self):
        ...
        # Mock dependencies
        with patch('src.ui.worker_manager.QThread') as mock_qthread, \
    ...
    def test_no_deprecated_parameters_in_any_method(self):
        ...
        methods = [method for method in dir(worker_manager) 
