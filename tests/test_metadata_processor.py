...
class TestMetadataProcessor:
    ...
    def test_set_and_get_rating(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=os.path.splitext(test_image)[1], delete=False) as tmp:
        ...
        try:
            ...
            for label in test_labels:
                ...
                if label in [None, ""]:
                    ...
                    assert results[norm_path]['label'] is None or results[norm_path]['label'] == ""
                else:
