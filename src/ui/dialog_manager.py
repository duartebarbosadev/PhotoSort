...
class DialogManager:
    ...
    def show_lossy_rotation_confirmation_dialog(self, filename: str, rotation_type: str) -> Tuple[bool, bool]:
        ...
        dialog.setStyleSheet("""
            ...
            QCheckBox#neverAskAgainCheckbox::indicator:hover { border-color: #505050; }
            QPushButton {
                padding: 8px 16px; border-radius: 4px; font-size: 9pt;
            }
            QPushButton#lossyRotationCancelButton {
                background-color: #383838; color: #D1D1D1;
                border: 1px solid #484848; min-width: 80px;
            }
            QPushButton#lossyRotationCancelButton:hover {
                background-color: #454545; border-color: #555555; color: #FFFFFF;
            }
            QPushButton#lossyRotationCancelButton:pressed { background-color: #303030; }
            QPushButton#lossyRotationProceedButton {
                background-color: #FF8C42; color: #FFFFFF;
                border: 1px solid #E67A35; min-width: 140px; font-weight: bold;
            }
            QPushButton#lossyRotationProceedButton:hover {
                background-color: #FF9D5C; border-color: #FF8C42;
            }
            QPushButton#lossyRotationProceedButton:pressed { background-color: #E67A35; }
        """)
    ...
    def show_confirm_delete_dialog(self, deleted_file_paths: List[str]) -> bool:
        ...
        dialog.setStyleSheet("""
            ...
            QMessageBox QLabel {
                color: #D1D1D1; background-color: transparent; padding-bottom: 10px;
            }
            QMessageBox QPushButton {
                background-color: #333333; color: #C0C0C0;
                border: 1px solid #404040; padding: 6px 15px;
                border-radius: 4px; min-height: 28px; min-width: 80px;
            }
            QMessageBox QPushButton:hover {
                background-color: #3D3D3D; border-color: #505050; color: #FFFFFF;
            }
            QMessageBox QPushButton:pressed { background-color: #2A2A2A; }
            QMessageBox QPushButton#confirmDeleteYesButton {
                background-color: #C92C2C; color: #FFFFFF;
                border: 1px solid #A02020; font-weight: bold;
            }
            QMessageBox QPushButton#confirmDeleteYesButton:hover {
                background-color: #E04040; border-color: #B03030;
            }
            QMessageBox QPushButton#confirmDeleteYesButton:pressed { background-color: #B02020; }
            ...
            QMessageBox QPushButton#confirmDeleteNoButton:pressed { background-color: #303030; }
        """)
