...
class LeftPanel(QWidget):
    ...
    def connect_signals(self):
        ...
        self.rotation_suggestions_view.selectionModel().selectionChanged.connect(self.main_window._handle_file_selection_changed)
    ...
    def _create_widgets(self):
        ...
        self.rotation_suggestions_view.setSelectionMode(QAbstractItemView.SelectionMode.ExtendedSelection)
        self.rotation_suggestions_view.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.rotation_suggestions_view.setContextMenuPolicy(Qt.ContextMenuPolicy.CustomContextMenu)
