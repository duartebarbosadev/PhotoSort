...
class ThumbnailCache:
    ...
    def __init__(
        self, cache_dir: str = DEFAULT_THUMBNAIL_CACHE_DIR, size_limit: int = DEFAULT_THUMBNAIL_CACHE_SIZE_BYTES
    ):  # Default 1GB limit
        ...
        self._cache = diskcache.Cache(
            directory=cache_dir, size_limit=size_limit, disk_min_file_size=THUMBNAIL_MIN_FILE_SIZE
        )
