...
- **jpegtran (Optional, for Lossless JPEG Rotation)**:
  ...
  - **Linux**: `sudo apt-get install libjpeg-turbo-progs` (Ubuntu/Debian) or `sudo yum install libjpeg-turbo-utils` (RedHat)
...
3. **Install dependencies:**
   Ensure your [`requirements.txt`](requirements.txt) is up-to-date with all necessary packages (PyQt6, Pillow, piexif, pillow-heif, rawpy, opencv-python, sentence-transformers, scikit-learn, numpy, send2trash, onnxruntime).
